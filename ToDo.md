...
## 2026-06-05 | Apply SDLClaude conventions to project root

### Background
The SDLClaude conventions repo is vendored under `SDLClaude/`.
...
### Work items
- [x] Copy `SDLClaude/CLAUDE.md` to project root
- [x] Copy `SDLClaude/.claude/settings.json` to `.claude/`
- [x] Copy the 5 hook scripts to `.claude/hooks/`
- [x] Copy `SDLClaude/.clang-format` to project root
