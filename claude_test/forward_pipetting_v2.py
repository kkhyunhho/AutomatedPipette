# Debug: forward pipetting dry-run that waits for each command to finish
# (its END line) before sending the next, so buffered motor commands are
# not cut off by disabling motor control too early. Empty tip, no liquid.
import asyncio
